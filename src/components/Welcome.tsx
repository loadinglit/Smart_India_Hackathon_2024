...
import { Phone, MessageSquare, DownloadIcon, DownloadCloud, DownloadCloudIcon, MoveDownIcon, ArrowDownCircle } from 'lucide-react';
    ...
    <div className="flex flex-col items-start max-w-4xl mx-auto mt-8">
      <div className="w-16 h-16 relative mb-6">
        ...
        <div className="absolute inset-1 bg-white dark:bg-gray-900 rounded-full flex items-center justify-center">
          <div className="text-1xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">Siva.AI</div>
        </div>
      </div>
      
      <h1 className="text-7xl font-bold mb-4">
        <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-transparent bg-clip-text">Hello, Bhoomika</span>
      </h1>
      <p className="text-2xl text-gray-700 dark:text-gray-400 mb-8">How can I help your enterprise level query today ? <br/>
