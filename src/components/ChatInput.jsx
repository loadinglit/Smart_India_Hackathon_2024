      ...
      <div className="p-4 border-t">
        <div className="relative">
          ...
          <input
            ...
            disabled={isLoading}
            className="w-full p-4 pl-14 pr-40 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 disabled:opacity-50"
          />
